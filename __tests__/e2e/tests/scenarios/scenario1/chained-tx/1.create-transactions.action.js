...
module.exports = async options => {
    ...
    // A => B
    let transaction1 = TransactionFactory.transfer(utils.b.address, 300 * Math.pow(10, 5), "transfer A => B")
    ...
    // B => C
    let transaction2 = TransactionFactory.transfer(utils.c.address, 250 * Math.pow(10, 5), "transfer B => C")
        .withFee(0.1 * Math.pow(10, 5))
